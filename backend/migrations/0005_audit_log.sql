...
-- and insert sites to enforce that lat/lng/geohash never appear here. IP + user_id +
...
COMMENT ON TABLE audit_log IS
    'Append-only event log. INVARIANT: no latitude/longitude/geohash columns or values, ever. Enforced by CI privacy gate.';
